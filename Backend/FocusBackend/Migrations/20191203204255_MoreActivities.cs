    ...
    public partial class MoreActivities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 7, new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), "Make The Restaurant Presentable", false, 5, "Clean Store", 10, 5 },
                    { 5, 5, new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), "Keep The Lights On", false, 8, "Pay Bills", 16, 8 },
                    { 6, 7, new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), "St Up Deliveries For Stock", false, 7, "Order Food", 12, 5 },
                    { 7, 1, new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), new DateTime(2019, 12, 3, 15, 42, 54, 843, DateTimeKind.Local), "Turn In Newspaper Add", false, 5, "Advertising", 14, 9 }
                });
        }
