...
namespace FocusBackend.Migrations
{
    ...
    [Migration("20191126203900_DataUpdate")]
            ...
            modelBuilder.Entity("FocusBackend.Models.Activity", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, CategoryID = 2, Completion = new DateTime(2019, 11, 26, 15, 39, 0, 92, DateTimeKind.Local), Creation = new DateTime(2019, 11, 26, 15, 39, 0, 91, DateTimeKind.Local), Description = "Outsourced From Temp Agency", Done = false, Importance = 9, Name = "Pay Workers", Rank = 18, Urgency = 9 },
                        new { ID = 2, CategoryID = 6, Completion = new DateTime(2019, 11, 26, 15, 39, 0, 93, DateTimeKind.Local), Creation = new DateTime(2019, 11, 26, 15, 39, 0, 93, DateTimeKind.Local), Description = "Follow Up With Prospects", Done = false, Importance = 10, Name = "Sales Planning", Rank = 13, Urgency = 3 },
                        new { ID = 3, CategoryID = 8, Completion = new DateTime(2019, 11, 26, 15, 39, 0, 93, DateTimeKind.Local), Creation = new DateTime(2019, 11, 26, 15, 39, 0, 93, DateTimeKind.Local), Description = "Get More Stamps For Pay Checks", Done = false, Importance = 4, Name = "Buy Stamps", Rank = 10, Urgency = 6 }
                    );
                });
