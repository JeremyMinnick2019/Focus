...
namespace FocusBackend.Migrations
{
    ...
    [Migration("20191126004413_SpecificData")]
            ...
            modelBuilder.Entity("FocusBackend.Models.Activity", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, CategoryID = 2, Completion = new DateTime(2019, 11, 25, 19, 44, 13, 103, DateTimeKind.Local), Creation = new DateTime(2019, 11, 25, 19, 44, 13, 102, DateTimeKind.Local), Description = "Outsourced From Temp Agency", Done = false, Importance = 9, Name = "Pay Workers", Rank = 18, Urgency = 9 },
                        new { ID = 2, CategoryID = 6, Completion = new DateTime(2019, 11, 25, 19, 44, 13, 103, DateTimeKind.Local), Creation = new DateTime(2019, 11, 25, 19, 44, 13, 103, DateTimeKind.Local), Description = "Follow Up With Prospects", Done = false, Importance = 10, Name = "Sales Planning", Rank = 13, Urgency = 3 },
                        new { ID = 3, CategoryID = 8, Completion = new DateTime(2019, 11, 25, 19, 44, 13, 103, DateTimeKind.Local), Creation = new DateTime(2019, 11, 25, 19, 44, 13, 103, DateTimeKind.Local), Description = "Get More Stamps For Pay Checks", Done = false, Importance = 4, Name = "Buy Stamps", Rank = 10, Urgency = 6 }
                    );
                });
            ...
            modelBuilder.Entity("FocusBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Email = "BGump@MyEmail.com", Image = "Image", Name = "Bubba Gump", Phone = "14404541980" }
                    );
                });
